...
-- Importante: usar hashes reales en producción. Aquí solo ejemplos.
INSERT IGNORE INTO usuarios (id, nombre, email, password_hash, rol_id, estado)
VALUES
  (1, 'Ana Pérez','ana@ejemplo.com','$2y$12$examplehash1',1,'Activo'),
  (2, 'Juan L.','juan@ejemplo.com','$2y$12$examplehash2',2,'Pendiente'),
  (3, 'María S.','maria@ejemplo.com','$2y$12$examplehash3',2,'Activo');

INSERT IGNORE INTO estudiantes (id, usuario_id) VALUES (1, 1);

INSERT IGNORE INTO asignaturas (id, nombre) VALUES (1, 'Matemática'),(2, 'Historia'),(3, 'Ciencias');
